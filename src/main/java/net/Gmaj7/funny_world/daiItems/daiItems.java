...
public class daiItems {
    ...
    public static final Supplier<Item> ROD_OF_LIGHTING = DAI_ITEMS.register("rod_of_lighting",
            () -> new RodOfLighting(new Item.Properties().stacksTo(1).durability(255).attributes(RodOfLighting.createAttributes())));
