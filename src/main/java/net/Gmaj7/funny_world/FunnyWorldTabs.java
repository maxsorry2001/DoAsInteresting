    ...
    public static final DeferredHolder<CreativeModeTab ,CreativeModeTab> DAI_TAB = DAI_CREATIVE_MODE_TABS.register("dai_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(daiItems.EXPLOSION_STORAGE.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(daiItems.CONVEX.get());
                        ...
                        pOutput.accept(daiItems.DRUM_STICK.get());
                        pOutput.accept(daiBlocks.BASS_DRUM.get());
                        pOutput.accept(daiBlocks.SNARE.get());
                        pOutput.accept(daiBlocks.HAT.get());
                        pOutput.accept(daiBlocks.COW_BELL.get());
        }).build());
        }
