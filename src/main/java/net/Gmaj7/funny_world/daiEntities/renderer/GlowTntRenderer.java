...
@OnlyIn(Dist.CLIENT)
public class GlowTntRenderer extends EntityRenderer<GlowTntEntity> {
    private final BlockRenderDispatcher blockRenderer;

    public GlowTntRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.shadowRadius = 0.5F;
        this.blockRenderer = pContext.getBlockRenderDispatcher();
    }

    public void render(GlowTntEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(GlowTntEntity pEntity) {
