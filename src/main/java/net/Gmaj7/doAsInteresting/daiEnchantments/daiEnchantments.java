...
public class daiEnchantments {
    ...
    public static final ResourceKey<Enchantment> HEAT_BY_FRICTION = ResourceKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath(DoAsInteresting.MODID, "heat_by_friction"));
